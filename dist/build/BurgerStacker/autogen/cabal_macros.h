...
/* package BurgerStacker-0.1.0.0 */
#ifndef VERSION_BurgerStacker
#define VERSION_BurgerStacker "0.1.0.0"
#endif /* VERSION_BurgerStacker */
#ifndef MIN_VERSION_BurgerStacker
#define MIN_VERSION_BurgerStacker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_BurgerStacker */
...
/* package JuicyPixels-3.3.2 */
#ifndef VERSION_JuicyPixels
#define VERSION_JuicyPixels "3.3.2"
...
#define CURRENT_COMPONENT_ID "BurgerStacker-0.1.0.0-9A5EajpKzcA3VSwdPdanJE-BurgerStacker"
